...
public class PinActivity extends FragmentActivity {
    ...
    public void requestPassword() {
        RequestForgotPasswordDialog.show(PinActivity.this.getSupportFragmentManager(), new RequestPasswordSuccessCallback() {
            @Override
            public void onSuccess(RequestForgotPasswordDialog requestForgotPasswordDialog) {
                Toast.makeText(PinActivity.this, R.string.password_correct, Toast.LENGTH_LONG).show();
            ...
            public void onFail(RequestForgotPasswordDialog requestForgotPasswordDialog) {
                Toast.makeText(PinActivity.this, R.string.password_incorrect, Toast.LENGTH_LONG).show();
